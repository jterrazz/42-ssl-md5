...
/*   Updated: 2019/07/27 12:47:56 by jterrazz         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
	...
	size_t buffer_count, t_bool is_little_endian)
{
	...
	{
		buffer = is_little_endian ?
			ft_bswap_uint32(buffers[buffer_i]) : buffers[buffer_i];
	...
	size_t buffer_count, t_bool is_little_endian)
{
	...
	{
		buffer = is_little_endian ?
			ft_bswap_uint64(buffers[buffer_i]) : buffers[buffer_i];
